    ...
    <>
      <div className="mt-5 flex flex-auto gap-4 w-full">
        <div className="w-[25%]">
          ...
          <TodoCardComponent data={taskData} status="1" bgColor={"#FFEE93"}/>
        </div>
        ...
        <div className="w-[25%]">
          ...
          <TodoCardComponent data={taskData} status="2" bgColor={"#306BFF"}/>
        </div>
        ...
        <div className="w-[25%]">
          ...
          <TodoCardComponent data={taskData} status="3" bgColor={"#FFB57F"}/>
        </div>
        ...
        <div className="w-[25%]">
          ...
          <TodoCardComponent data={taskData} status="4" bgColor={"#78C552"}/>
        </div>
      </div>
    </>
  );
